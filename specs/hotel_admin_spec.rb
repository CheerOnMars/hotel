...
describe "HotelAdmin class" do
  ...
  describe "calculates reservation cost" do
    it "calculates the cost of a given reservation" do
      ...
      reservation = Hotel::Reservation.new({start_date: "2015-07-20", end_date: "2015-07-25", room_id: 1})
  ...
  describe "dates reservations method" do
    ...
    it "returns a list of reservations for a specific date" do
      hotel_admin = Hotel::HotelAdmin.new
      reservation_a = Hotel::Reservation.new({start_date: "2015-07-20", end_date: "2015-07-25", room_id: 1})
      reservation_b = Hotel::Reservation.new({start_date: "2015-07-21", end_date: "2015-07-25", room_id: 2})
      hotel_admin.add_reservation(reservation_a)
      hotel_admin.add_reservation(reservation_b)
      hotel_admin.access_reservations("2015-07-20").must_equal [reservation_a]
